...
static const ROMPTR struct {uint8_t bLength;uint8_t bDescriptorType; uint16_t chars[14]; } product_string = {
	...
	DESC_STRING,
	{'E','L','L','O',' ','C','o','m','p','u','t','e','r',0}
};

static const ROMPTR struct {uint8_t bLength;uint8_t bDescriptorType; uint16_t chars[14]; } cdc_interface_string = {
	sizeof(cdc_interface_string),
	DESC_STRING,
	{'C','D','C',' ','I','n','t','e','r','f','a','c','e',0}
};

static const ROMPTR struct {uint8_t bLength;uint8_t bDescriptorType; uint16_t chars[19]; } cdc_data_string = {
	sizeof(cdc_data_string),
	DESC_STRING,
	{'C','D','C',' ','D','a','t','a',' ','I','n','t','e','r','f','a','c','e',0}
};

static const ROMPTR struct {uint8_t bLength;uint8_t bDescriptorType; uint16_t chars[49]; } fake_serial_num = {
	sizeof(fake_serial_num),
	DESC_STRING,
	{'D','o','n','\'','t',' ','w','e',' ','a','l','l',' ','m','i','s','s',' ','t','h','e',
	 ' ','g','o','o','d',' ','o','l','d',' ','r','e','a','l',' ','s','e','r','i','a','l',
     ' ','p','o','r','t','?',0}
};
